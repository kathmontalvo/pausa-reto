    ...
    <div class="container menu-resp">
		<div class="row">
			<div class="col-lg-12 text-right">
				{{-- <a href="javascript:void(0)" style="display: block;margin-bottom:22.5px;margin-top:15px;">
					<img src="{{asset('img/icons/ingles.png')}}" alt=""> --}}
			@if($language == 'es')
				<a href="{{ route('change', 'en') }}" style="display: block;margin-bottom:22.5px;margin-top:15px;">
					<img src="{{asset('img/icons/ingles.png')}}" alt="">
				</a>
			@else
				<a href="{{ route('change', 'es') }}" style="display: block;margin-bottom:22.5px;margin-top:15px;">
					<img src="{{asset('img/icons/espanol.png')}}" alt="">
				</a>
			@endif
			</div>
		</div>
        <div class="navbar yamm">
            <div class="navbar-header">
				...
				<a href="{{asset($language . '/')}}" class="navbar-brand">
					<img src="{{asset('img/icons/pausa-logo.png')}}" alt="logo">
				</a>
            </div>
            <div id="navbar-collapse-grid" class="navbar-collapse collapse">
                <div class="logo-menu-sidebar"><a href="{{asset($language . '/')}}" class="navbar-brand"><img src="{{asset('img/icons/pausa-logo.png')}}"
                                                                             alt="logo"></a></div>
                <ul class="nav navbar-nav navbar-right">
                    <!-- Grid 12 Menu -->
                    <li><a href="{{asset($language . '/')}}">{!!trans('header.head1')!!}</a></li>
                    <!-- <li><a href="#">Nosotros</a></li> -->
                    <li class="dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">{!!trans('header.head2')!!}</a>
                        <ul class="dropdown-menu">
                            <li class="grid-gnx">
                                <div class="row">
                                    <div class="col-sm-4 text-center">
                                        <div class="mapa-region">
		<svg version="1.1" id="mapa-region" xmlns="http://www.w3.org/2000/svg"
				xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				viewBox="0 0 1876.3 2517.3"
				style="enable-background:new 0 0 1876.3 2517.3;" xml:space="preserve">
			<g id="XMLID_2_">
				<g>
					...
					<path class="selva" data-d="selva" d="M1756.8,1704.6c2.4,5,2.2,8.8-2.2,12.3c-1.1,0.9-1.8,2.3-2.7,3.4c-6.7,7.6-6.7,7.5-2.1,15.4
					...
					<path class="sierra" data-d="sierra" d="M1730.6,1931.8c0.9,2.4-1.3,4.1-3.6,4.6c-12.7,2.5-18.5,9.7-16.2,22.8c0.3,1.6-0.8,2.7-2.1,3.5
					...
					<path class="st0"
						d="M1600,2129.2c4.7,1.3,5.9,4.2,6.9,7.4C1602.2,2134.9,1602.2,2134.9,1600,2129.2z"/>
					...
					<path class="costa active" data-d="costa" d="M1597.1,2434.1c0.4,2.2-2.1,5.2-3.7,7.7c-5.5,8.6-11.2,17-16.7,25.5c-2,3.1-4.6,4.5-8.1,4.5
				...
				<g>
                                    ...
                                    <div class="col-sm-4 link-mapa-menu">
										<a href="#" data-r="costa" class="costa active">{!!trans('header.costa')!!}</a>
										<a href="#" data-r="sierra" class="sierra">{!!trans('header.sierra')!!}</a>
										<a href="#" data-r="selva" class="selva">{!!trans('header.selva')!!}</a>
                                    </div>
                                    <div class="col-sm-4 link-mapa-item">
                                        <div id="item-detalle-menu" class="mCustomScrollbar">
                                            @foreach($rutas as $ruta)
										{{-- <a href="{{$language}}/rutas/{{ $ruta->url }}"> --}}
                    ...
                    <li><a href="{{asset($language . '/preguntas-frecuentes')}}">{!!trans('header.head3')!!}</a></li>
                    <li><a href="https://medium.com/pausa-travel" target="_blank">{!!trans('header.head4')!!}</a></li>
                    <li><a href="{{asset($language . '/contacto')}}">{!!trans('header.head5')!!}</a></li>

                    @if(!\Auth::user())
                        <li><a href="{{asset($language . '/login')}}" class="btn btn-naranja">{!!trans('header.head6')!!}</a></li>
                    @else
                        <li>
                          <span><i class="fa fa-user"></i><a href="{{asset($language . '/user/reservas')}}" style="color:#fff"> {!!trans('header.head7')!!}</a></span>
                        </li>
                        <li>
                            <a href="#" class="btn btn-naranja btnSalir">
                                {!!trans('header.head8')!!}
                            </a>
